...
import { Activity, ArrowDownToLine, BookOpen, ClipboardCheck, Compass, FilePlus2, FolderInput, FolderOpen, GitBranch, GitPullRequest, Globe2, LayoutDashboard, Library, ListTree, Map, Play, RefreshCw, Settings2, ShieldCheck, Sparkles, Users, Waypoints } from 'lucide-react'
...
export default function App() {
  const {project, chapter, busy, error, view, dirty, open, overview, runtime, review, proposals, create, imports, settings, exports, parity} = useStudio()
